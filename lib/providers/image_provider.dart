...
class Images with ChangeNotifier {
  ...
  Future<void> getImages() async {
    List<ImageModel> loadedimage = await imageSearch(
        'https://pixabay.com/api/?key=17844631-1a0191a2feabf070a0377cdc4&editors_choice=true&per_page=49&orientation=vertical&image_type=photo&safesearch=true&pretty=true');
